...
[Registro.de.Teste.de.Usabilidade.xlsx](https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2022-2-e2-proj-int-t3-e-friender/files/10181204/Registro.de.Teste.de.Usabilidade.xlsx)
...
| **TAREFA 7 - EXECUTAR UM MATCH COM OUTRO USUÁRIO**  | O match está ocorrendo conforme o previsto. | A aparência está muito simples, faltam recursos.  |   Tarefa realizada com sucesso. |    :I |          
